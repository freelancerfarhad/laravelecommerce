            ...
            <div class="col-lg-9">
                ...
                <div class="masonry-loader masonry-loader-loaded">
                    <div class="row products product-thumb-info-list" data-plugin-masonry="" data-plugin-options="{'layoutMode': 'fitRows'}" style="position: relative; height: 1088.95px;">
                        @foreach (App\Models\Category::where('is_parent',$pcategory->id)->get() as $pCat)
                    
                        @foreach (App\Models\Product::where('category_id',$pCat->id)->get() as $product)
                            @if ($product->count() > 0)
                            ...
                            @else
                            <div class="alert alert-info">No Product found in this category, Please Check Back Later...</div>
                            @endif
                        @endforeach
